<template>
	<view class="main bg-white" >
		<cu-custom bgColor="bg-main" :isBack="true"><block slot="backText"></block><block slot="content">发布零活 1/3</block></cu-custom>
		...
		<view  class="">
			...
			<scroll-view scroll-y :class="modalName=='viewModal' ? 'DrawerPage show' : ''" >
				<view class="cu-form-group margin-top-sm" style="border: 0;">
					<view class="title" style="font-size: 30upx;">零活标题</view>
				...
				<view @tap="ShowType" class="cu-form-group margin-top-sm">
					<view class="title" style="font-size: 30upx;">零活类型</view>
...
<!-- 				<view v-if="loadBody" class="cu-modal" :class="modalName=='RadioModal'?'show':''" @tap="hideModal">
				...
				<view  class="" style="width: 750upx; height: 20upx; background-color: #f5f5f5;">
				...
				<view  class="flex justify-end text-gray margin-tb-sm" style="width: 725upx; font-size: 26upx;">
						...
						<view class=" margin-top" style="width: 750upx; height: 20upx; background-color: #f5f5f5;">
