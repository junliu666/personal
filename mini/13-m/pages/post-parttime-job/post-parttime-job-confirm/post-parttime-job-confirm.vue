<template>
	<view class="main bg-white" >
		...
		<view @tap="GoPostOne" class="margin-top " style="border-radius: 15upx; margin-left: 25upx; width: 700upx; padding-top: 20upx; padding-bottom: 20upx; padding-right: 20upx; padding-left: 20upx; border: 3px solid #f5f5f5 ;">
...
<!-- 		<view class="flex flex-wrap margin-left-sm" style="width: 700upx;">
		...
		<view class="margin-top" style="height: 40upx; background-color: #F5F5F5; width: 750upx;">
