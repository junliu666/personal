<template>
	<view style="min-height: 100vh; background-color: white;">
		<cu-custom bgColor="bg-main" :isBack="true">
			<block slot="backText"></block><block slot="content">银行卡</block>
			<view class="" slot="right">
				<text @click="GoBankAdd" class=" padding-sm cuIcon-add" style="font-size: 40upx;"></text>
			</view>
		</cu-custom>
...
<script>
	...
	export default {
		...
		methods: {
			...
			GoBankAdd(){
				uni.navigateTo({
					url: 'my-wallet-bankcard-add/my-wallet-bankcard-add'
				})
			},
			GetImgColor(){
