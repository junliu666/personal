<template>
	<view class="bg-white">
		<cu-custom bgColor="bg-black" :isBack="true"><block slot="backText">返回</block><block slot="content">用户协议</block></cu-custom>
		<view class="margin-left-sm" style="width: 700upx;">
			<view class="text-bold">1.特别提示</view>
			...
			<view class="text-bold margin-top">2.服务内容</view>
			<view class="margin-top-sm">
				2.1云足点钟系统是一个帮助用户预约足疗技师的平台，平台内严禁一切非法、涉黄信息，违反社区运营规范者，一律封号处理。
			</view>
			<view class="margin-top-sm">
				2.2本应用服务的具体内容由本应用制作者根据实际情况提供。
			</view>
			<view class="margin-top-sm">
				 2.3 除非本注册及服务协议另有其它明示规定，本应用所推出的新产品、新功能、新服务，均受到本注册及注册协议规范。2.4 本应用仅提供相关的网络服务，除此之外与相关网络服务有关的设备(如个人电脑、手机、及其他与接入互联网或移动网有关的装置)及所需的费用(如为接入互联网而支付的电话费及上网费、为使用移动网而支付的手机费)均应由用户自行负担。
			</view>
			
			<view class="text-bold margin-top">3.使用规则</view>
			<view class="margin-top-sm">
				3.1 用户帐号注册
			</view>
			<view class="margin-top-sm">
				3.1.1 使用本应用系统注册的用户，将通过微信授权登录的方式，未注册的用户不能使用部分功能（打赏，预约，用户信息管理等）。
			</view>
			<view class="margin-top-sm">
			...
			<view class="margin-top-sm">
				3.4因黑客行为或用户的保管疏忽导致帐号非法使用，本应用不承担任何责任。
			</view>
			<view class="margin-top-sm">
			...
			<view class="margin-top-sm">
				3.6当第三方认为用户发表或者上传于本应用的信息侵犯其权利，并根据《信息网络传播权保护条例》或者相关法律规定向本应用发送权利通知书时，用户同意本应用可以自行判断决定删除涉嫌侵权信息，除非用户提交书面证据材料排除侵权的可能性，本应用将不会自动恢复上述删除的信息；<br>
				(1)不得为任何非法目的而使用网络服务系统；<br>
				
				(2)遵守所有与网络服务有关的网络协议、规定和程序；<br>
				
				(3)不得利用本应用的服务进行任何可能对互联网的正常运转造成不利影响的行为；<br>
			...
			<view class="text-bold margin-top">4.责任声明</view>
			...
			<view class="text-bold margin-top">5.知识产权</view>
			<view class="margin-tb-sm">
			...
			<view class="margin-tb-sm">
				5.3 本应用的所有内容，包括商品描述、图片等内容所有权归属于心动APP的用户，任何人不得转载。
			</view>
			<view class="margin-tb-sm">
			...
			<view class="text-bold margin-top">6.隐私保护</view>
			<view class="margin-tb-sm">
				6.1 本系统不对外公开或向第三方提供单个用户的注册资料及用户在使用网络服务时存储在本社区的非公开内容，但下列情况除外：<br>
				(1)事先获得用户的明确授权； <br>
				(2)根据有关的法律法规要求；<br>
				(3)按照相关政府主管部门的要求；<br>
				(4)为维护社会公众的利益。 <br>
			...
			<view class="text-bold margin-top">7.协议修改</view>
			<view class="margin-tb-sm">
			...
			<view class="text-bold margin-top">8.通知送达</view>
			<view class="margin-tb-sm">
