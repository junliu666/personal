<template>
	<view>
		<view class="cu-custom" :style="[{height:CustomBar + 'px'}]">
			<view class="cu-bar-main fixed flex justify-between align-center" :style="style" :topic="topic" :class="[bgImage!=''?'none-bg text-white bg-img':'',bgColor]">
				<slot name="icon"></slot>
		...
		<view class="cu-modal drawer-modal justify-start " style="z-index: 9999; " :class="modalName=='DrawerModalL'?'show':''" @tap="hideModal">
				<view @click.stop="" scroll-y  style=" overflow: auto;" class=" cu-dialog basis-lg"  :style="[{top:0+'px',height:'100vh', width: '60vw'}]">
					<view     class="">
