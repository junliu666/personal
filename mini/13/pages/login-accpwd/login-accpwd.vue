<template>
	<view class="bg-white main">
		...
		<view class="margin-left-login justify-center flex-direction flex" style="height: 45vh; ">
			<view class="cu-form-group padding-tb margin-top" style="height: 50upx; border-bottom: 1px solid #f5f5f5; width: 600upx;">
				<input pattern="[0-9]*"  maxlength="11"  type="number" placeholder="请输入手机号/用户ID"  v-model="tel" style="font-size: 36upx;"></input>
